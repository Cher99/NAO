...
cd Make/Linux
echo "Input your IP:192.168.67."
read ip
./copyfiles $usingTarget 192.168.67.$ip -v 50 -b
cd

elif [ $number -eq 22 ];then
cd Make/Linux
echo "Input your IP:10.0.67."
read ip
./copyfiles $usingTarget 10.0.67.$ip -v 50 -b
cd
...
echo "Input your IP:192.168.67."
read ip
ping -c 10 192.168.67.$ip

elif [ $number -eq 88 ];then
echo "Input your IP:10.0.67."
read ip
ping -c 10 10.0.67.$ip
