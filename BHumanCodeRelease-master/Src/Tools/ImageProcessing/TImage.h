...
//declare a template called Pixel
...
public:
  ...
  TImage& operator=(const TImage<Pixel>& other)
  {
    ...
    memcpy(image, other[0], other.width * other.height * sizeof(Pixel));// C++ function
    return *this;
  }



  //some overload fuction, armed to ?
